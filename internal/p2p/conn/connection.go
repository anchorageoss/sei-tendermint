...
import (
	...
	"github.com/anchorageoss/sei-tendermint/internal/libs/flowrate"
	"github.com/anchorageoss/sei-tendermint/internal/libs/protoio"
	"github.com/anchorageoss/sei-tendermint/internal/libs/timer"
	...
	for {
		...
		*/
		...
		case *tmp2p.Packet_PacketPing:
			...
			// https://github.com/anchorageoss/sei-tendermint/issues/1190
			select {
			case c.pong <- struct{}{}:
			default:
				// never block
...
type channel struct {
	...
	// See https://github.com/anchorageoss/sei-tendermint/issues/7000.
	recentlySent int64
